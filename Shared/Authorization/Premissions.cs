...
public static class Permissions
{
    private static readonly Permission[] AllPermissions =
    {
        ...
        new("View Colors", Action.View, Resource.Colors, IsBasic: true),
        new("Search Colors", Action.Search, Resource.Colors, IsBasic: true),
        new("Create Colors", Action.Create, Resource.Colors),
        new("Update Colors", Action.Update, Resource.Colors),
        new("Delete Colors", Action.Delete, Resource.Colors),
